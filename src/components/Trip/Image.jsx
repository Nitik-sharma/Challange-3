    ...
    <div className=" w-full relative z-1">
      ...
      {falag === false ? (
        ...
        <div className=" flex flex-col w-[80%] h-6  flex-start left-[20%] absolute top-[5%] md:top-[10%]  ">
          <h1 className="text-sm md:text-6xl font-semibold font-mono text-white  tracking-wide mr-32 md:mr-0">
            {htext}
          </h1>
          <label className=" text-start  text-sm font-medium text-white md:ml-20 md:mt-10 ml-10 mt-0  ">
            email
          </label>
          <input
            type="email"
          ...
          />
          <button className=" text-sm w-[40%]  p-2  mb-3  ml-16 mt-1 rounded-md bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 text-yellow-50 font-mono capitalize md:text-3xl md:p-4 md:m-16 md:ml-48">
            {buttonText}
          </button>
        </div>
      )}
